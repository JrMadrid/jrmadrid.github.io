          ...
          <ul class="navbar-nav me-auto mb-2 mb-xl-0">
            ...
            <a class="nav-link dropdown-toggle active" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aaria-labelledby="navbarDarkDropdownMenuLink">
                        <li class="botonnav"><a class="dropdown-item" href="registropostulante.php">Postulantes</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li class="botonnav"><a class="dropdown-item" href="registroempresa.php">Empresas</a></li>
                    </ul>
            </li>
            ...
            <a class="nav-link dropdown-toggle active" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aaria-labelledby="navbarDarkDropdownMenuLink">
                        <li class="botonnav"><a class="dropdown-item" href="vacante.php">Vacante</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li class="botonnav"><a class="dropdown-item" href="contrato.php">Contrato</a></li>
                    </ul>
            </li>
