...
<div name=reporte>
  <div class="d-flex w-100" style="height:120vh;">
      ...
      <h1>Registro Usuario Postulante</h1>
      <center>
        <div class="w-75" style="text-align:left;">
          ...
          <form onsubmit="return validar()" method="POST" action="agregar/agregarpostulante.php">
            ...
            <div>
              <label class="fw-bold" for="nombre">Nombres Usuario: *</label>
              <input class="w-75" type="text" maxlength="20" id="nombre" name="nombre" placeholder="Completo!" required>
            </div>
            <div>
              <label class="fw-bold" for="contra">Contraseña: *</label>
              <input class="w-75"  maxlength="20"  type="password" id="contra" name="contra" placeholder="Completo!" required>
            </div>
            <div>
              <label class="fw-bold" for="veri">Confirme Contraseña: *</label>
              <input class="w-75"  maxlength="20"  type="password" id="veri" name="veri" placeholder="Completo!" required>
            </div>
